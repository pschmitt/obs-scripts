...
cmdtxt.DEFAULT_COMMAND = string.format("timewarrior::today-total --minutes || echo '%s'", DEFAULT_VALUE)
...
local function update_text_source_with_cmd_output()
	...
	if text == nil or text == "" then
		print(string.format("ERROR: Command returned no output. Defaulting to %s", DEFAULT_VALUE))
		text = DEFAULT_VALUE
	end
